# TSUZU P0 Implementation Source of Truth v2.0

- Date: 2026-09-09
- Status: **FINAL P0 IMPLEMENTATION DOCUMENTATION BASELINE / DOCUMENTATION CLOSED / CODE PENDING**
- Supersedes integration-bundle status views: v1.0 / v1.1 / v1.2 audited / v1.3 R5-closed.
- Does NOT supersede historical canonical decision documents as records; their precedence is preserved below.
- Product name remains `TSUZU` for implementation; `AHA` naming exploration is deferred.
...
```text
Canonical Product/Architecture        CLOSED
Slice A specification A1-A10         CLOSED / Ready to implement
Slice B specification B1-B11         CLOSED / Ready to implement
Remaining P0 specification R1-R10    CLOSED / Ready to implement or execute spike
Cross-document responsibility audit  PASS
Code implementation                  NOT CLAIMED
Golden Case execution                NOT CLAIMED
Founder Product Proof                NOT CLAIMED
```

There is **no known P0 responsibility in v1.1/v1.2/v1.2.1 that remains without a named implementation/evaluation owner Contract**.

The next phase is code implementation from A1 according to the Final Implementation Execution Plan.
...
1. v1.2.1 Closing Addendum
2. v1.2 Addendum
3. v1.1 Canonical Product & Architecture Baseline
4. older savepoints/conversation records

Scoped implementation:

1. named implementation Contract inside its owned responsibility
2. parent Slice/plan
3. v1.2.1
4. v1.2
5. v1.1

A scoped Contract may close implementation ambiguity but may not weaken Product Constitution, Security, User Ownership, Deletion or Recoverability invariants.
...
1. read Current Contract Index;
2. read Final Implementation Execution Plan;
3. load only the current owning Contract + direct dependencies;
4. implement/test;
5. do not reinterpret later appendices as a newer status view.

Each embedded source below is bounded by a `SOURCE BOUNDARY`. Exact hashes are in `MANIFEST.sha256`.
...
# SOURCE BOUNDARY — CURRENT CONTRACT INDEX — TSUZU_P0_Contract_Index_v2.0_20260909.md
...
# SOURCE BOUNDARY — FINAL CROSS-DOCUMENT AUDIT — TSUZU_P0_Final_Cross_Document_Audit_v1.0_20260909.md
...
# SOURCE BOUNDARY — FINAL IMPLEMENTATION EXECUTION PLAN — TSUZU_P0_Final_Implementation_Execution_Plan_v1.0_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_Canonical_Product_Architecture_v1.1_20260906(3).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_Canonical_Addendum_v1.2_20260906(3).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_Canonical_Closing_Addendum_v1.2.1_20260906(2).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Vertical_Slice_A_Implementation_Plan_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A1_Canonical_Source_Contract_v0.1_20260906(2).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A2_Atomic_Vault_Writer_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A3_Local_Capture_Secret_Guard_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A4_Single_Writer_Worker_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A5_SQLite_FTS_Derived_Index_Rebuild_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A6_Minimal_Tombstone_Deletion_Ledger_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A7_Retrieval_Policy_Egress_Gate_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A8_Context_Bundle_Source_Trace_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A9_Claude_Code_MCP_Adapter_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_A10_E2E_Golden_Cases_Exit_Gate_Contract_v0.1_20260906(1).md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Vertical_Slice_B_Contract_Index_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Vertical_Slice_B_Implementation_Plan_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B1_Claude_Code_Conversation_Chronicle_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B2_Episode_Segmentation_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B3_Experience_Candidate_Provenance_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B4_Decision_Case_Assertion_Evidence_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B5_Decision_Reconciliation_Correction_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B6_Experience_Trace_Outcome_Learning_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B7_Promotion_Dependency_Invalidation_Recompute_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B8_Personal_Discovery_4_Lane_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B9_Discovery_Context_Injection_Claude_Host_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B10_Product_Proof_Event_Denominator_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_Slice_B11_Founder_Golden_Cases_Exit_Gate_Contract_v0.1_20260907.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R1_Acquisition_Fetcher_Adapter_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R2_X_Acquisition_Rescue_Route_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R3_Historical_Bootstrap_Apple_Notes_Markdown_Import_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R4_iOS_Share_Create_Only_Capture_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R5_Backup_Restore_Schema_Migration_Recovery_Contract_v0.1_20260908.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R6_Passive_Recall_Trusted_Intent_Invisible_Egress_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R7_Thin_Control_Plane_Settings_Health_Privacy_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R8_Codex_Cursor_Host_Adapter_Expansion_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R9_Web_Chat_Chronicle_One_Way_Validation_Spike_Contract_v0.1_20260909.md
...
# SOURCE BOUNDARY — SOURCE — TSUZU_P0_R10_Founder_Product_Proof_Experiment_Gate_Calibration_Contract_v0.1_20260909.md
